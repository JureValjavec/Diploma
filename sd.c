...
//BOOL spi_rw (Sercom * SERCOMx, UINT8 *w_buff, UINT8 *r_buff, UINT32 lenght)
...
#define rcvr_mmc(r_buff, lenght) spi_rw(SERCOM1, NULL, r_buff, lenght)
#define xmit_mmc(w_buff, lenght) spi_rw(SERCOM1, w_buff, NULL, lenght)
...
int select (void)	/* 1:OK, 0:Timeout */
{
	...
	PORT->Group[0].OUTCLR.reg = PORT_PA17;	/* Set CS# low */
